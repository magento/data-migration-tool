...
class Version11410to2000 extends DatabaseStep implements \Migration\Step\StepInterface
{
    ...
    protected function migrateRewrites($source, $destination)
    {
        ...
        foreach ($source as $sourceRecord) {
                ...
                case 1:
                    ...
                    if ($recordDuplicate) {
                        $destinationRecord->setValue(
                            'request_path',
                            $sourceRecord->getValue('request_path') . md5($sourceRecord->getValue('url_rewrite_id'))
                        );
                    }
                    break;
                case 2:
            ...
            if ($recordDuplicate) {
                $message = sprintf(
                    'Duplicate resolved. Request path was: %s Target path was: %s New request path: ',
