...
class CollectionTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $structure1 = $this->getMock(\Migration\ResourceModel\Structure::class, [], [], '', false);
        $structure2 = $this->getMock(\Migration\ResourceModel\Structure::class, [], [], '', false);
        $structure3 = $this->getMock(\Migration\ResourceModel\Structure::class, [], [], '', false);
