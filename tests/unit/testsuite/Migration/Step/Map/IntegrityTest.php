...
{
    /**
     * @var \Migration\Step\ProgressBar|\PHPUnit_Framework_MockObject_MockObject
     */
    protected $progress;
    ...
    public function setUp()
    {
        ...
        $this->progress = $this->getMock('\Migration\Step\ProgressBar', ['start', 'finish', 'advance'], [], '', false);
